defmodule CAIWeb.CoreComponents do
  @moduledoc """
  ...
  def input(assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <input
        ...
        class={[
          "mt-2 block w-full rounded-lg text-zinc-100 focus:ring-0 ",
          "phx-no-feedback:border-zinc-300 phx-no-feedback:focus:border-cyan-400",
          @errors == [] && "border-zinc-300 focus:border-zinc-400",
          @errors != [] && "border-rose-400 focus:border-rose-400"
        ]}
        {@rest}
  ...
  @doc """
  Formats a unix timestamp to the user's local timezone.
  """
  attr(:id, :string, required: true)
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CAIWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CAIWeb.Gettext, "errors", msg, opts)
    end
  end
