defmodule CAI.Characters.WeaponStatByFaction do
  @moduledoc """
  Ecto embedded schema for a character's weapon stats by faction
  """
  ...
  embedded_schema do
    ...
    # belongs_to :character, CAI.Characters, foreign_key: :character_id
  end
